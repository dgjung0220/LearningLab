...
public class FileLogger {
    ...
    public void startNewLog() {
        ...
        synchronized (mFileLock) {
            ...
            Date now = new Date();
            String fileName = String.format("%s_%s.csv", FILE_PREFIX, formatter.format(now));
            ...
            try {
                currentFileWriter.write(
                        "Provider, UserTime, SysTime, Latitude, Longitude, Altitude, Bearing, BearingAccDegress, Acc, Speed, SpeedAccPerSecond");
            } catch(IOException e){
